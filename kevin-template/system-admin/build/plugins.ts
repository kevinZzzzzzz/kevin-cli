 ...
 * @param viteEnv
 */
export const createVitePlugins = (viteEnv: any): (PluginOption | PluginOption[])[] => {
 ...
 * @param viteEnv
 */
const createCompression = (viteEnv: any): PluginOption | PluginOption[] => {
 ...
 * @param viteEnv
 */
const createVitePwa = (viteEnv: any): PluginOption | PluginOption[] => {
